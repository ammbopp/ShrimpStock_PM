...
import './AcademicHome.css'; // ใช้ไฟล์ CSS นี้สำหรับการตกแต่งที่เหมือนกับหน้า RequestHistory
    ...
    return (
        <div className="page-container">
          ...
          <div className="content">
            ...
            <h1>Welcome, <span id="username">{employee_fname || 'Guest'} {employee_lname || ''}</span> to Academic Dashboard 🧑‍🔬</h1>
            <hr />
            <div className="notice-card">
              <h2 className="notice-title">
                ...
                <span className="view-all" style={{ cursor: 'pointer', color: '#BD5D3A' }} 
                onClick={() => navigateToPage('/academic/requests/:employee_id')}>view all</span>
              </h2>
